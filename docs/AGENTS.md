...
- The public site is hosted on Cloudflare at https://github.com/Melvynx/agent-burn.

Use the root `development` guidance for shared repository validation.

## Content Rules

- Prefer the renamed public commands in new or edited docs: `agent-burn summary`, `agent-burn harness claude`, and `agent-burn harness codex`.
