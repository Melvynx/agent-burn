...
const package_dirs = {
    darwin-arm64: 'agent-burn-darwin-arm64'
    darwin-x64: 'agent-burn-darwin-x64'
    linux-arm64: 'agent-burn-linux-arm64'
    linux-x64: 'agent-burn-linux-x64'
    win32-arm64: 'agent-burn-win32-arm64'
    win32-x64: 'agent-burn-win32-x64'
}
def main [--platform: string, --arch: string, --binary: string] {
    ...
    let binary_name = if $platform == 'win32' { 'agent-burn.exe' } else { 'agent-burn' }
